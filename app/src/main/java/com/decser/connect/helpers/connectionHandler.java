...
import com.decser.connect.DashboardActivity;
import com.decser.connect.PeerConnectActivity;
...
public class connectionHandler extends AsyncTask<Void, Void, Session> {
    ...
    public connectionHandler(String hostname, String username, Context mContext) throws JSchException {
        ...
        String Path = Environment.getExternalStorageDirectory().getPath() + "/decser/" + keyName;
